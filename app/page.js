...
import CheckboxSection from "@/components/Section ";
              ...
              <div className="row d-flex justify-content-center  align-items-center">
                <div className="col-12 col-lg-6 text-center d-flex justify-content-center d text-white">
                  ...
                  <div className="instr ">
                    ...
                    <div className="d-flex justify-content-start align-items-center ">
                      <img src="tick.png" alt="tick" />
                      <p className="mt-3">Add property Location</p>
                    </div>
                    <div className="d-flex justify-content-start align-items-center ">
                      <img src="tick.png" alt="tick" />
                      <p className="mt-3">
                    ...
                    <div className="d-flex justify-content-start align-items-center ">
                      <img src="tick.png" alt="tick" />
                      <p className="mt-3">Add Price details</p>
                    </div>
                    <div className="d-flex justify-content-start align-items-center ">
                      <img src="tick.png" alt="tick" />
                      <p className="mt-3">Add your best Property Shots</p>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-lg-6">
                  <div className="form-main">
                    ...
                    <form className="form1">
                      ...
                      <label className="mt-5" htmlFor="country">
                    ...
                    <div className="bottom d-flex">
                      <p>
                        Need Help?{" "}
                        <span style={{ color: "black" }}> Call 9999999999</span>
                      </p>
